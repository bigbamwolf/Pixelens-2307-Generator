...
async function generatePdf() {
  ...
  page.setFont(boldFont);
  drawDigits(page, payorTinDigits, payorTinCenters, 630.0, 9.8, { font: boldFont, color: black });
...
drawText(page, 'G8-4 2ND FLOOR GEMS PLAZA CIRCUMFERENTIAL ROAD SAN JOSE, ANTIPOLO CITY', 68, 600.0, 8.2, { color: black, maxWidth: 492, lineHeight: 9 });
