...
async function generatePdf() {
  ...
  page.setFont(boldFont);
  drawDigits(page, payorTinDigits, payorTinCenters, 683.0, 9.8, { font: boldFont, color: black });

  page.setFont(font);
  drawText(page, 'PIXELENS CREATIVE ADVERTISING INC.', 68, 659.0, 10, { color: black, maxWidth: 500 });
  drawText(page, 'G8-4 2ND FLOOR GEMS PLAZA CIRCUMFERENTIAL ROAD SAN JOSE, ANTIPOLO CITY', 68, 629.0, 8.2, { color: black, maxWidth: 492, lineHeight: 9 });
  drawDigits(page, '1870', payorZipCenters, 631.0, 9.0, { font: boldFont, color: black });
